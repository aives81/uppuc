            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="room-btn pt-20">
                        <a href="categorie.blade.php" class="btn view-btn1">View All Places</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="categorie.blade.php">Leving Hotel</a></h5>
                                <p>Must explain your how this keind denoun pleasure</p>
                                <a href="categorie.blade.php">View Details</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="categorie.blade.php">Night Life</a></h5>
                                <p>Must explain your how this keind denoun pleasure</p>
                                <a href="categorie.blade.php">View Details</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="categorie.blade.php">Culture Place</a></h5>
                                <p>Must explain your how this keind denoun pleasure</p>
                                <a href="categorie.blade.php">View Details</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="categorie.blade.php">Resturent</a></h5>
                                <p>Must explain your how this keind denoun pleasure</p>
                                <a href="categorie.blade.php">View Details</a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-caption">
                                ...
                                <h3><a href="blog.blade.php">The Best SPA Salons For
