                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="categorie.blade.php">Catagories</a></li>
                                            <li><a href="listing.blade.php">Listing</a></li>
                                            <li><a href="#">Page</a>
                                                <ul class="submenu">
                                                    <li><a href="blog.blade.php">Blog</a></li>
                                                    <li><a href="blog_details.blade.php">Blog Details</a></li>
                                                    <li><a href="elements.blade.php">Element</a></li>
                                                    <li><a href="listing_details.blade.php">Listing details</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="contact.blade.php">Contact</a></li>
                                            <li class="add-list"><a href="listing_details.blade.php"><i class="ti-plus"></i> add Listing</a></li>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-listing mb-30">
                                    ...
                                    <div class="list-caption">
                                        <span>Open</span>
                                         <h3><a href="listing_details.blade.php">Saintmartine</a></h3>
